...
Introduce roles and responsibilities for accessibility. Explain that implementing web accessibility requires involvement from the whole team.
...
* Introduce some accessibility features and specify which role(s) would be responsible for them. Explain that there might be only one role or several roles involved.
