...
Show examples of accessible page titles and link text. Explain that it is best practice to put unique and most relevant information first in page titles to favor readability and efficiency. For details, see [Provide Informative, Unique Page Titles](/tips/writing/#provide-informative-unique-page-titles), and [Make Link Test Meaningful](/tips/writing/#make-link-text-meaningful).
