...
* **Grant:** For information on providing grants and other opportunities to support WAI, please email [giving@w3.org](mailto:giving@w3.org?subject=Accessibility%20support).

For other ways to get involved in WAI, such as contributing to W3C accessibility work by reviewing drafts, see [[Participate in WAI]](/about/participate-in-wai/).
...
The organizations below provided financial support for W3C WAI work **before W3C was established as a 501(c)3 public-interest non-profit organization**._
