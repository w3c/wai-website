...
Comment or raise a new issue in the [ACT GitHub repository](https://github.com/w3c/wcag-act/issues/) or [email the task force](mailto:public-wcag-act@w3.org) (**Note:** This email will go to a publicly archived mailing list).
...
* [Facilitators](https://www.w3.org/groups/tf/wcag-act/participants/#chairs)
...
* [Accessibility Conformance Testing (ACT) Rules Format 1.1 — W3C Recommendation](https://www.w3.org/TR/act-rules-format-1.1/) (and latest [Editor’s Draft](https://w3c.github.io/wcag-act/act-rules-format.html))
