...
[2012 Annual report and accounts ![HTML]({{ "/content-images/tutorials/images/html5logo.png" | relative_url }}) (43KB)]({{ "/tutorials/images/example-link/" | relative_url }}), also available in [![Word document]({{ "/content-images/tutorials/images/worddocument.png" | relative_url }}) (254KB)]({{ "/tutorials/images/example-link/" | relative_url }}) or [![PDF]({{ "/content-images/tutorials/images/pdfdocument.png" | relative_url }}) (353KB)]({{ "/tutorials/images/example-link/" | relative_url }}) format.
