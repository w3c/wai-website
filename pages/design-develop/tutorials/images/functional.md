...
[![W3C home]({{ "/content-images/tutorials/images/w3c.png" | relative_url }})](https://www.w3.org/)
...
[![]({{ "/content-images/tutorials/images/w3c.png" | relative_url }}){:style="vertical-align: middle; margin-right: 1em;"}W3C Home](https://www.w3.org/){:style="display:inline-block;"}
...
[W3C Home page ![new window]({{ "/content-images/tutorials/images/new-window.png" | relative_url }})](https://www.w3.org/)
...
[![Print this page]({{ "/content-images/tutorials/images/print.png" | relative_url }})](javascript:print())
...
<form action="#" method="post">
  <p>
    ...
    <input name="submit" src="{{ "/content-images/tutorials/images/searchbutton.png" | relative_url }}" alt="Search" type="image" style="vertical-align: middle; display:inline-block; border: none;">
  </p>
</form>
