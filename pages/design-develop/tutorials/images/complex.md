...
<img src="{{ "/content-images/tutorials/images/chart.png" | relative_url }}" alt="Bar chart showing monthly and total visitors for the first quarter 2014 for sites 1 to 3"><br><a href="{{ "/tutorials/images/examples/2014-first-qtr/" | relative_url }}">Image Description</a>
...
Among the approaches below, the first one makes the information available to other programs, such as web browsers and search engines.
...
<img src="{{ "/content-images/tutorials/images/peafowl.jpg" | relative_url }}" alt="Male peacock head" aria-describedby="description">
<p id="description">
