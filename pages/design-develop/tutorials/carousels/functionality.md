...
{% include ednote.html note="The following paragraph was show in a side column before." %} Find more information about WAI-ARIA in the [WAI-ARIA Overview](/standards-guidelines/aria/), the [WAI-ARIA Authoring Practices](https://www.w3.org/TR/wai-aria-practices-1.1/) and the [Specification](https://www.w3.org/TR/wai-aria-1.1/).
