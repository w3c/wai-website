...
<div id="c" class="carousel">
    <ul>
        <li class="slide" style="background-image: url('{{ "/content-images/tutorials/carousels/ex-teddy1.jpg" | relative_url }}');">
        ...
        <li class="slide" style="background-image: url('{{ "/content-images/tutorials/carousels/ex-teddy2.jpg" | relative_url }}');">
        ...
        <li class="slide" style="background-image: url('{{ "/content-images/tutorials/carousels/ex-teddy3.jpg" | relative_url }}');">
...
var myCarousel = (function() {
  ...
  function init(set) {
    ...
    ctrls.innerHTML = '<li>' +
        '<button type="button" class="btn-prev"><img src="{{ "/content-images/tutorials/carousels/chevron-left.png" | relative_url }}" alt="Previous Item"></button>' +
      '</li>' +
      '<li>' +
        '<button type="button" class="btn-next"><img src="{{ "/content-images/tutorials/carousels/chevron-right.png" | relative_url }}" alt="Next Item"></button>' +
      '</li>';
