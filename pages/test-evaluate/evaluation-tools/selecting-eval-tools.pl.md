...
footer: >
   <p><strong>Data:</strong> Informacje o konkretnych narzędziach są często aktualizowane, gdy je otrzymujemy. W informacjach dla każdego narzędzia znajduje się data ostatniej aktualizacji. Interfejs użytkownika Lista narzędzi oceny został odnowiony w grudniu 2023 r. Po raz pierwszy opublikowany w marcu 2006 roku.</p>
...
Narzędzia oceny dostępności stron internetowych mogą pomóc w szybkim rozpoznaniu potencjalnych problemów z dostępnością. Można z nich korzystać na wszystkich etapach procesu projektowania i tworzenia stron internetowych. Narzędzia mogą zapewniać w pełni zautomatyzowane testy i pomagać w ręcznym przeglądaniu.
