...
github:
  ...
  path: pages/test-eval/evaluation-tools/index.md  # Add the language shortcode to the middle of the filename, for example: content/index.fr.md
  label: wai-evaluation-tools

permalink: /test-evaluate/tools/  # Add the language shortcode to the end, with no slash at end, for example: /link/to/page/fr
