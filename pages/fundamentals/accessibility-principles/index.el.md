...
translation:
  last_updated: 2026-06-23   # Put the date of this translation YYYY-MM-DD (with month in the middle)

translators:
- name: "Χρυσάνθη Μηλιτσοπούλου"
- name: "Anastasis Vourliotakis"
...
Αυτή η σελίδα εισάγει ορισμένες απο τις απαιτήσεις προσβασιμότητας για ιστοτόπους, διαδικτυακές εφαρμογές, προγράμματα περιήγησης και άλλα εργαλεία στον ιστό . Παρέχει αναφορές στα διεθνή πρότυπα της Πρωτοβουλίας για την Προσβασιμότητα στον Ιστό (WAI) του W3C και σε [ιστορίες χρηστών του ιστού](/people-use-web/user-stories/).

**Σημείωση:** Αυτή δεν αποτελεί μια πλήρη λίστα όλων των απαιτήσεων προσβασιμότητας.
...
Η προσβασιμότητα στον ιστό βασίζεται σε διάφορα στοιχεία που συνεργάζονται μεταξύ τους. Ορισμένα από αυτά περιλαμβάνουν:

-   **Περιεχόμενο ιστού**{:#webcontent} - αναφέρεται σε οποιοδήποτε τμήμα ενός ιστοτόπου που περιλαμβάνει κείμενο, εικόνες, φόρμες, πολυμέσα, καθώς και σε οτιδήποτε αφορά κώδικα σήμανσης (markup code), σενάρια (<span lang="en">scripts</span>), εφαρμογές (<span lang="en">applications</span>) και άλλα.
-   **Πράκτορες χρήστη (<span lang="en">user agents</span>)**{:#useragents} - το λογισμικό που χρησιμοποιούν οι άνθρωποι για να έχουν πρόσβαση στο περιεχόμενο του ιστού, συμπεριλαμβανομένων των προγραμμάτων περιηγησης (browsers) γραφικών για επιτραπέζιους υπολογιστές (desktops), των προγραμμάτων περιήγησης μέσω φωνής, των προγραμμάτων περιήγησης για κινητά τηλέφωνα, των προγραμμάτων αναπαραγωγής πολυμέσων, των πρόσθετων (plug-ins), και ορισμένων [υποστηρικτικών τεχνολογιών (<span lang="en">assistive technologies</span>)](/people-use-web/tools-techniques/#at).
-   **Εργαλεία συγγραφής (<span lang="en">authoring tools</span>)**{:#authoringtools} -  το λογισμικό ή οι υπηρεσίες που χρησιμοποιούν οι άνθρωποι για την παραγωγή περιεχομένου στον ιστό, συμπεριλαμβανομένων των προγραμμάτων επεξεργασίας κώδικα, των εργαλείων μετατροπής εγγράφων, των συστημάτων διαχείριστης περιεχομένου, των ιστολογίων (<span lang="en">blogs</span>), των σεναριών (<span lang="en">scripts</span>) για βάσεις δεδομένων, καθώς και άλλων εργαλείων.

{% include excol.html type="start" %}

### Περισσότερα σχετικά με τα πρότυπα προσβασιμότητας στον ιστό
{:.no_toc}

{% include excol.html type="middle" %}

Αυτά τα στοιχεία αλληλοσυνδέονται και υποστηρίζουν το ένα το άλλο. Για παράδειγμα, το **περιεχόμενο του ιστού** πρέπει να περιλαμβάνει εναλλακτικά κείμενα για εικόνες. Αυτή η πληροφορία πρέπει να υποβληθεί σε επεξεργασία από τα **προγράμματα περιήγησης** και στη συνέχεια να μεταφερθεί σε **υποστηρικτικές τεχνολογίες**, όπως σε αναγνώστες οθόνης. Για να δημιουργήσουν τέτοια εναλλακτικά κείμενα, οι συγγραφείς χρειάζονται τα **εργαλεία συγγραφής** που τους υποστηρίζουν να το κάνουν. Περισσότερες πληροφορίες παρέχονται στα  [[Βασικά συστατικά για την Προσβασιμότητα στον Ιστό]](/fundamentals/components/)

Τα πρότυπα διαδραματίζουν έναν κρίσιμο ρόλο στον καθορισμό των απαιτήσεων προσβασιμότητας για κάθε ένα από αυτά τα στοιχεία. Ορισμένες απαιτήσεις προσβασιμότητας είναι εύκολο να ικανοποιηθούν, ωστόσο η κατανόηση των βασικών αρχών για το πως οι άνθρωποι με αναπηρίες χρησιμοποιούν τον Ιστό βοηθά στο να εφαρμοστούν πιο αποτελεσματικά και αποδοτικά. Ορισμένες πτυχές της προσβασιμότητας απαιτούν περισσότερες τεχνικές δεξιότητες ή προηγμένες γνώσεις για τον τρόπο με τον οποίο οι άνθρωποι χρησιμοποιούν τον Ιστό. Σε κάθε περίπτωση, [η συμμετοχή χρηστών από τα πρώτα στάδια και καθ' όλη τη διάρκεια των διαδικτυακών σας έργων](/test-evaluate/involving-users/) θα κάνει τη δουλειά σας καλύτερη και ευκολότερη.

Η Πρωτοβουλία για την Προσβασιμότητα του Ιστού του W3C (WAI) παρέχει ένα σύνολο κατευθυντήριων οδηγιών που αναγνωρίζεται διεθνώς ως το πρότυπο για την προσβασιμότητα στον ιστό. Σε αυτές περιλαμβάνονται:

-   **[Οδηγίες για την Προσβασιμότητα Περιεχομένου στον Ιστό (WCAG)](/standards-guidelines/wcag/)**
-   **[Οδηγίες για την Προσβασιμότητα Πρακτόρων Χρήστη (UAAG)](/standards-guidelines/uaag/)**
-   **[Οδηγίες για την Προσβασιμότητα Εργαλείων Συγγραφής (ATAG)](/standards-guidelines/atag/)**

Υπάρχει επίσης μία προδιαγραφή του WAI για τις **[ Προσβάσιμες Πλούσιες Εφαρμογές Διαδικτύου(WAI-ARIA)](/standards-guidelines/aria/)**, η οποία περιλαμβάνει δυναμικό περιεχόμενο και προηγμένα στοιχεία ελέγχου διεπαφής χρήστη ανεπτυγμένα με Ajax, JavaScript και σχετικές τεχνολογίες Παγκοσμίου Ιστού.
...
-   Περιγραφή δεδομένων που παρουσιάζονται σε γραφήματα, διαγράμματα και εικονογραφήσεις
-   Σύντομες περιγραφές για μη κειμενικό περιεχόμενο, όπως είναι τα αρχεία ήχου και βίντεο
-   Ετικέτες για στοιχεία ελέγχου φορμών, εισαγωγής δεδομένων, καθώς και άλλων στοιχείων διεπαφής
...
-   [Κατευθυντήρια γραμμή Α.3.7: (Για τη διεπαφή χρήστη του εργαλείου συγγραφής) Διασφαλίστε ότι οι προεσκοπήσεις είναι τουλάχιστον το ίδιο προσβάσιμες και εντός της αγοράς των πρακτόρων χρήστη](https://www.w3.org/TR/ATAG20/#gl_a37)
...
- [[Ade, δημοσιογράφος με περιορισμένη χρήση των χεριών του]](/people-use-web/user-stories/story-one/)
- [[Lakshmi, ανώτερο στέλεχος - λογίστρια που είναι τυφλή]](/people-use-web/user-stories/story-three/)
- [[Dhruv, μεγαλύτερος ενήλικας μαθητής που είναι κωφός]](/people-use-web/user-stories/story-six/)
- [[Marta, βοηθός μάρκετινγκ που είναι κωφή και τυφλή]](/people-use-web/user-stories/story-seven/)
- [[Stefan, μαθητής με διαταραχή ελλειμματικής προσοχής και υπερκινητικότητας, καθώς και με δυσλεξία]](/people-use-web/user-stories/story-eight/)
- [[Elias, συνταξιούχος με περιορισμένη όραση, τρέμουλο στα χέρια και ήπιου βαθμού απώλεια βραχυπρόθεσμης μνήμης]](/people-use-web/user-stories/story-nine/)
...
### Το περιεχόμενο είναι πιο εύκολο να το δει και να το ακούσει κανείς {#distinguishable}
...
-   Το κείμενο επαναπροσαρμόζεται σε μικρά παράθυρα ("ορατή περιοχή") και όταν οι χρήστες μεγαλώνουν το κείμενο
-   Οι εικόνες κειμένου μπορούν να αλλάξουν μέγεθος, να αντικατασταθούν με πραγματικό κείμενο ή να αποφεύγονται όπου είναι δυνατόν
...
Η εκπλήρωση αυτής της απαίτησης βοηθά στον διαχωρισμό του προσκηνίου (<span lang="en">foreground</span>) από το φόντο (<span lang="en">background</span>), ώστε οι σημαντικές πληροφορίες να είναι πιο διακριτές. Αυτό περιλαμβάνει ζητήματα που αφορούν άτομα που δεν χρησιμοποιούν υποστηρικτικές τεχνολογίες και άτομα που χρησιμοποιούν υποστηρικτικές τεχνολογίες και ενδέχεται να παρατηρήσουν παρεμβολές από εμφανές ηχητικό ή οπτικό περιεχόμενο στο φόντο. Για παράδειγμα, πολλά άτομα με αχρωματοψία δεν χρησιμοποιούν συγκεκριμένα εργαλεία και βασίζονται σε έναν κατάλληλο σχεδιασμό που παρέχει επαρκή χρωματική αντίθεση μεταξύ του κειμένου και του περιβάλλοντος φόντου. Για άλλους, ο ήχος που αναπαράγεται αυτόματα θα μπορούσε να επηρεάσει τη μετατροπή κειμένου σε ομιλία ή τις [συσκευές ακουστικής υποστήριξης (ALD)](/teach-advocate/accessible-presentations/#ald).

Η ικανοποίηση αυτής της απαίτησης βοηθά στο διαχωρισμό του προσκηνίου από το παρασκήνιο, ώστε η σημαντική πληροφορία να γίνει πιο διακριτή . Αυτό περιλαμβάνει σκέψεις για άτομα που δεν χρησιμοποιούν υποστηρικτικές τεχνολογίες και για άτομα χρήστες υποστηρικτικών τεχνολογιών που ενδέχεται να παρατηρήσουν παρεμβολή από εξέχων ακουστικό ή οπτικό περιεχόμενο στο παρασκήνιο. Για παράδειγμα, πολλοί άνθρωποι με αχρωματοψία δεν χρησιμοποιούν συγκεκριμένα εργαλεία και βασίζονται σε ένα σωστό σχεδιασμό που παρέχει επαρκή χρωματική αντίθεση μεταξύ του κειμένου και του περιβάλλοντος παρασκηνίου. Για άλλους, ο ήχος που αναπαράγεται αυτόματα θα μπορούσε να παρεμβάλει με λογισμικά κειμένου σε ομιλία ή με [υποστηρικτικές ακουστικές συσκευές(ALDs)](/teach-advocate/accessible-presentations/#ald).
...
- [[Ian, υπάλληλος καταχώρισης δεδομένων με αυτισμό]](/people-use-web/user-stories/story-two/)
- [[Lakshmi, ανώτερο στέλεχος - λογίστρια που είναι τυφλή]](/people-use-web/user-stories/story-three/)
- [[Lexie, καταναλώτρια που πραγματοποιεί αγορές μέσω διαδικτύου που δυσκολεύεται να διακρίνει ορισμένα χρώματα (αχρωματοψία)]](/people-use-web/user-stories/story-four/)
- [[Dhruv, μεγαλύτερος ενήλικας μαθητής που είναι κωφός]](/people-use-web/user-stories/story-six/)
- [[Marta, βοηθός μάρκετινγκ που είναι κωφή και τυφλή]](/people-use-web/user-stories/story-seven/)
- [[Elias, συνταξιούχος με περιορισμένη όραση, τρέμουλο στα χέρια και ήπιου βαθμού απώλεια βραχυπρόθεσμης μνήμης]](/people-use-web/user-stories/story-nine/)
...
-   Τα προγράμματα περιήγησης, τα εργαλεία συγγραφής και άλλα εργαλεία παρέχουν υποστήριξη μέσω πληκτρολογίου

Η εκπλήρωση αυτής της απαίτησης βοηθά τους χρήστες πληκτρολογίου, συμπεριλαμβανομένων των ατόμων που χρησιμοποιούν εναλλακτικά πληκτρολόγια, όπως πληκτρολόγια με εργονομική διάταξη, πληκτρολόγια οθόνης ή συσκευές διακοπτών (<span lang="en">switch</span>). Βοηθά επίσης άτομα που χρησιμοποιούν φωνητική αναγνώριση (εισαγωγή ομιλίας) να χειρίζονται ιστότοπους και να υπαγορεύουν κείμενο μέσω της διεπαφής του πληκτρολογίου.
...
-   Οι σελίδες έχουν σαφείς τίτλους και είναι οργανωμένες με τη χρήση περιγραφικών επικεφαλίδων στις ενότητες
...
-   Η εστίαση του πληκτρολογίου είναι ορατή και η και η σειρά της εστίασης ακολουθεί μια αλληλουχία με νόημα
-   Ο σκοπός ενός συνδέσμου είναι προφανής, ιδανικά ακόμη και όταν ο σύνδεσμος προβάλλεται μόνος του

Η εκπλήρωση αυτής της απαίτησης βοηθά τους ανθρώπους να πλοηγούνται σε ιστοσελίδες με διαφορετικούς τρόπους, ανάλογα με τις ιδιαίτερες ανάγκες και προτιμήσεις τους. Για παράδειγμα, ενώ ορισμένοι βασίζονται σε ιεραρχικές δομές πλοήγησης, όπως είναι οι γραμμές μενού, για να βρουν συγκεκριμένες ιστοσελίδες, άλλοι βασίζονται σε λειτουργίες αναζήτησης σε ιστότοπους. Κάποιοι μπορεί να βλέπουν το περιεχόμενο, ενώ άλλοι μπορεί να το ακούν ή να το βλέπουν και να το ακούν ταυτόχρονα. Κάποιοι μπορεί να χρησιμοποιούν το περιεχόμενο μόνο με ποντίκι ή πληκτρολόγιο, ενώ άλλοι μπορεί να χρησιμοποιούν και τα δύο.
...
- [[Ian, υπάλληλος καταχώρισης δεδομένων με αυτισμό]](/people-use-web/user-stories/story-two/)
- [[Lakshmi, ανώτερο στέλεχος - λογίστρια που είναι τυφλή]](/people-use-web/user-stories/story-three/)
- [[Sophie, φίλαθλος της καλαθοσφαίρισης με σύνδρομο Down]](/people-use-web/user-stories/story-five/)
- [[Marta, βοηθός μάρκετινγκ που είναι κωφή και τυφλή]](/people-use-web/user-stories/story-seven/)
- [[Stefan, μαθητής με διαταραχή ελλειμματικής προσοχής και υπερκινητικότητας, καθώς και με δυσλεξία]](/people-use-web/user-stories/story-eight/)
- [[Elias, συνταξιούχος με περιορισμένη όραση, τρέμουλο στα χέρια και ήπιου βαθμού απώλεια βραχυπρόθεσμης μνήμης]](/people-use-web/user-stories/story-nine/)
...
Οι τρόποι εισαγωγής δεδομένων εκτός του πληκτρολογίου, όπως είναι η ενεργοποίηση μέσω αφής, η αναγνώριση φωνής (εισαγωγή ομιλίας) και οι χειρονομίες κάνουν το περιεχόμενο πιο εύκολο στη χρήση από πολλούς ανθρώπους. Ωστόσο, δεν μπορούν όλοι να χρησιμοποιήσουν καθεμία από αυτές τις μεθόδους εισαγωγής δεδομένων και στον ίδιο βαθμό. Ορισμένες σχεδιαστικές επιλογές μεγιστοποιούν το όφελος αυτών των τρόπων εισαγωγής δεδομένων. Αυτό περιλαμβάνει:
...
Η εκπλήρωση αυτής της απαίτησης καθιστά το περιεχόμενο πιο εύχρηστο για πολλά άτομα με ευρύ φάσμα ικανοτήτων που χρησιμοποιούν ένα ευρύ φάσμα συσκευών. Αυτό περιλαμβάνει περιεχόμενο που χρησιμοποιείται σε κινητά τηλέφωνα, tablet και τερματικά αυτοεξυπηρέτησης, όπως μηχανήματα έκδοσης εισιτηρίων.
...
Οι συγγραφείς περιεχομένου πρέπει να διασφαλίζουν ότι το περιεχόμενο κειμένου είναι ευανάγνωστο και κατανοητό στο ευρύτερο δυνατό κοινό, συμπεριλαμβανομένης της ανάγνωσης του δυνατά από λογισμικό μετατροπής κειμένου σε ομιλία. Τέτοιο περιεχόμενο περιλαμβάνει:
...
-   Σχετική βοήθεια ως προς το γενικότερο πλαίσιο για πιο σύνθετη λειτουργικότητα και αλληλεπίδραση
