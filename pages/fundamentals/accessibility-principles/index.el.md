...
-   **Περιεχόμενο ιστού**{:#webcontent} - αναφέρεται σε οποιοδήποτε τμήμα ενός ιστοτόπου που περιλαμβάνει κείμενο, εικόνες, φόρμες, πολυμέσα, καθώς και σε οτιδήποτε αφορά κώδικα σήμανσης (markup code), σενάρια (scripts), εφαρμογές (applications) και άλλα.
...
- [[Dhruv, μεγαλύτερος ενήλικας μαθητής που είναι κωφός]]()
