...
Captions 1.0 (IMSC1)](https://www.w3.org/TR/ttml-imsc1/). Bitmap subtitles/captions cannot be customized by users, which may diminish their usefulness to viewers with certain types of visual impairments.  Learn more about [why caption customization is important]({% link _media-intro/production-audio-description.md %}#custom_cc).
...
subtitle.]({{site.github.url}}/media-intro/img/cc_sub_together.png)
