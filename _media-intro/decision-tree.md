...
-   **Does the media contain only audio and no video?**
	-   {:.yes} **Yes:**
      ...
      _Provide captions or a complete transcript. See [production options for captions]({% link _media-intro/production-audio-description.md %}) or [transcript concepts and examples](transcript.html)._
...
-   **Does the media contain visual elements with synchronized audio?**
	-   {:.yes} **Yes:**
    	...
    	_Provide extended descriptions. See [SC 1.2.7](https://www.w3.org/TR/UNDERSTANDING-WCAG20/media-equiv-extended-ad.html). Or provide a pre-description; see [production options for descriptions]({% link _media-intro/production-audio-description.md %})._
	-   {:.no} **No:**
		- Continue.
